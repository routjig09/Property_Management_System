...
export function RegisterPage() {
  ...
  return (
    <div className="h-dvh bg-ivory flex">
      {/* Left: Image */}
      <div className="hidden lg:block md:w-1/2 h-dvh">
        <img
      ...
      {/* Right: Form */}
      <div className="w-full md:w-1/2 min-h-dvh flex items-center justify-center px-6 py-6">
        <div className="w-full max-w-md">
          <div className="mb-4">
            <Link to="/">
              <Logo variant="full" size="lg" className="mb-3" />
            </Link>
            <h1 className="text-3xl font-heading font-bold text-navy-900 mb-2">Create an account</h1>
            <p className="text-navy-500 font-body">Join PropSync to find your perfect property</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5">
            ...
            <Input label="Full Name" placeholder="John Doe" error={errors.name?.message} className="h-11" {...register('name')} />
            <Input label="Email" type="email" placeholder="you@example.com" error={errors.email?.message} className="h-11" {...register('email')} />
